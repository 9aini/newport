...
CREATE TABLE `ap_user_fan`  (
  ...
  `fans_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '粉丝ID',
  `fans_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '粉丝昵称',
  `level` tinyint(0) UNSIGNED NULL DEFAULT NULL COMMENT '粉丝忠实度\r\n            0 正常\r\n            1 潜力股\r\n            2 勇士\r\n            3 铁杆\r\n            4 老铁',
  `created_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `is_display` tinyint(0) UNSIGNED NULL DEFAULT NULL COMMENT '是否可见我动态',
  `is_shield_letter` tinyint(0) UNSIGNED NULL DEFAULT NULL COMMENT '是否屏蔽私信',
  `is_shield_comment` tinyint(0) UNSIGNED NULL DEFAULT NULL COMMENT '是否屏蔽评论',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `ap_user_follow`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '用户ID',
  `follow_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '关注作者ID',
  `follow_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '粉丝昵称',
  `level` tinyint(0) UNSIGNED NULL DEFAULT NULL COMMENT '关注度\r\n            0 偶尔感兴趣\r\n            1 一般\r\n            2 经常\r\n            3 高度',
  `is_notice` tinyint(0) UNSIGNED NULL DEFAULT NULL COMMENT '是否动态通知',
  `created_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `ap_user_realname`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '账号ID',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'APP实名认证信息表' ROW_FORMAT = Dynamic;
