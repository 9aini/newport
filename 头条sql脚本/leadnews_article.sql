...
) ENGINE = InnoDB AUTO_INCREMENT = 1383828014629179393 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '文章信息表，存储已发布的文章' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1383828014645956609 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'APP已发布文章配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ap_article_content`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_article_id`(`article_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1383828014650150914 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'APP已发布文章内容表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ap_author`  (
  ...
  `name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '作者名称',
  `type` tinyint(0) UNSIGNED NULL DEFAULT NULL COMMENT '0 爬取数据\r\n            1 签约合作商\r\n            2 平台自媒体人\r\n            ',
  `user_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '社交账号ID',
  `created_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `wm_user_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '自媒体账号',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_type_name`(`type`, `name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'APP文章作者信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ap_collection`  (
  `id` bigint(0) UNSIGNED NOT NULL AUTO_INCREMENT,
  `entry_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '实体ID',
  `article_id` bigint(0) UNSIGNED NULL DEFAULT NULL COMMENT '文章ID',
  `type` tinyint(0) UNSIGNED NULL DEFAULT NULL COMMENT '点赞内容类型\r\n            0文章\r\n            1动态',
  `collection_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `published_time` datetime(0) NULL DEFAULT NULL COMMENT '发布时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_user_type`(`entry_id`, `article_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'APP收藏信息表' ROW_FORMAT = Dynamic;
