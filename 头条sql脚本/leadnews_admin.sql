...
CREATE TABLE `ad_article_statistics`  (
  ...
  `article_we_media` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '主账号ID',
  `article_crawlers` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '子账号ID',
  `channel_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '频道ID',
  `read_20` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '草读量',
  `read_100` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '读完量',
  `read_count` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '阅读量',
  `comment` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '评论量',
  `follow` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '关注量',
  `collection` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '收藏量',
  `forward` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '转发量',
  `likes` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '点赞量',
  `unlikes` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '不喜欢',
  `unfollow` int(0) UNSIGNED NULL DEFAULT NULL COMMENT 'unfollow',
...
CREATE TABLE `ad_channel_label`  (
  ...
  `channel_id` int(0) UNSIGNED NULL DEFAULT NULL,
  `label_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '标签ID',
  `ord` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1117 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '频道标签信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ad_function`  (
  ...
  `parent_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '父功能',
...
CREATE TABLE `ad_label`  (
  ...
  `type` tinyint(0) UNSIGNED NULL DEFAULT NULL COMMENT '0系统增加\r\n            1人工增加',
  `created_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_name`(`name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 24236 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '标签信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ad_menu`  (
  ...
  `parent_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '父菜单',
  `created_time` datetime(0) NULL DEFAULT NULL COMMENT '登录时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `ad_recommend_strategy`  (
  ...
  `group_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '分组ID',
  `created_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `ad_role`  (
  ...
  `is_enable` tinyint(0) UNSIGNED NULL DEFAULT NULL COMMENT '是否有效',
  `created_time` datetime(0) NULL DEFAULT NULL COMMENT '登录时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `ad_role_auth`  (
  ...
  `type` tinyint(0) UNSIGNED NULL DEFAULT NULL COMMENT '资源类型\r\n            0 菜单\r\n            1 功能',
  `entry_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '资源ID',
  `created_time` datetime(0) NULL DEFAULT NULL COMMENT '登录时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `ad_user_equipment`  (
  ...
  `type` tinyint(0) UNSIGNED NULL DEFAULT NULL COMMENT '0PC\r\n            1ANDROID\r\n            2IOS\r\n            3PAD\r\n            9 其他',
...
CREATE TABLE `ad_user_login`  (
  `id` int(0) UNSIGNED NOT NULL,
  `user_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '用户ID',
  `equipment_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '登录设备ID',
...
CREATE TABLE `ad_user_opertion`  (
  ...
  `ip` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '登录IP',
  `address` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '登录地址',
  `type` int(0) NULL DEFAULT NULL COMMENT '操作类型',
...
CREATE TABLE `ad_vistor_statistics`  (
  `id` int(0) UNSIGNED NOT NULL COMMENT '主键',
  `activity` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '日活',
  `vistor` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '访问量',
  `ip` int(0) UNSIGNED NULL DEFAULT NULL COMMENT 'IP量',
  `register` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '注册量',
  `created_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
