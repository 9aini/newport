/*
 ...
 Source Schema         : leadnews-wemedia

 Target Server Type    : MySQL
 Target Server Version : 80026
 File Encoding         : 65001

 Date: 16/09/2022 19:39:53
*/
...
CREATE TABLE `wm_fans_statistics`  (
  ...
  `user_id` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '主账号ID',
  `article` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '子账号ID',
  `read_count` int(0) UNSIGNED NULL DEFAULT NULL,
  `comment` int(0) UNSIGNED NULL DEFAULT NULL,
  `follow` int(0) UNSIGNED NULL DEFAULT NULL,
  `collection` int(0) UNSIGNED NULL DEFAULT NULL,
  `forward` int(0) UNSIGNED NULL DEFAULT NULL,
  `likes` int(0) UNSIGNED NULL DEFAULT NULL,
  `unlikes` int(0) UNSIGNED NULL DEFAULT NULL,
  `unfollow` int(0) UNSIGNED NULL DEFAULT NULL,
...
CREATE TABLE `wm_news_statistics`  (
  ...
  `unfollow` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '取消关注量',
  `burst` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `created_time` date NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_user_id_time`(`user_id`, `created_time`) USING BTREE
...
CREATE TABLE `wm_user`  (
  `id` int(0) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `ap_user_id` int(0) NULL DEFAULT NULL,
  `ap_author_id` int(0) NULL DEFAULT NULL,
  ...
  `score` tinyint(0) UNSIGNED NULL DEFAULT NULL COMMENT '运营评分',
